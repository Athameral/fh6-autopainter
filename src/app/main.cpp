...
// already included in 3rd/taichi
#include <volk.h>
#endif
...
int main(int, char **)
{
    ...
    params.sample_bins = 1024;
    params.sample_leak_ratio = 0.1f;
    params.blur_size = 5;
    params.canvas_w = 1024;
    params.canvas_h = 662;
    params.sharpen_intensity = 1.0f;
    params.mutations_per_round = 8000;
    params.move_step = 8.0f;
